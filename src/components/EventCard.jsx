...
const EventCard = () => {
  ...
  return (
    <div className="bg-gray-800 p-4 sm:p-6 rounded-lg mt-4 max-w-lg mx-auto w-[90%] text-white">
      ...
      <button 
        ...
        className="mt-4 w-full bg-pink-500 hover:bg-pink-600 text-white py-2 px-4 rounded-lg"
      >
        Accept Invite →
      </button>
    </div>
